...
// Final Project
#define HIGHMEM 0xF2000000

#ifdef HIGHMEM
	static physaddr_t* high_mem;
	uintptr_t kmap(physaddr_t);
	void kunmap_high(void*);
	uintptr_t kmap_high(struct Page*);
#endif
...
int	page_alloc_high(struct Page **pp_store, int i);
