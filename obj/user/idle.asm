...
umain(void)
{
  ...
  800037:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  80003a:	c7 05 00 60 80 00 e0 	movl   $0x8027e0,0x806000
  800041:	27 80 00 
	...
	while (1) {
		sys_yield();
  800044:	e8 fd 04 00 00       	call   800546 <sys_yield>
...
libmain(int argc, char **argv)
{
  ...
  80005e:	e8 17 05 00 00       	call   80057a <sys_getenvid>
	env = &envs[ENVX(envid)];
...
exit(void)
{
  ...
  80009f:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000a2:	e8 44 0a 00 00       	call   800aeb <close_all>
	sys_env_destroy(0);
  8000a7:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000ae:	e8 fb 04 00 00       	call   8005ae <sys_env_destroy>
}
  8000b3:	c9                   	leave  
  8000b4:	c3                   	ret    
...
sys_page_insert(envid_t envid, void *va, struct Page *p, int perm)
{
  ...
  800133:	b8 12 00 00 00       	mov    $0x12,%eax
  800138:	8b 7d 14             	mov    0x14(%ebp),%edi
  80013b:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  800148:	7e 28                	jle    800172 <sys_page_insert+0x53>
		panic("syscall %d returned %d (> 0)", num, ret);
  80014a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80014e:	c7 44 24 0c 12 00 00 	movl   $0x12,0xc(%esp)
  800155:	00 
  800156:	c7 44 24 08 fc 27 80 	movl   $0x8027fc,0x8(%esp)
  80015d:	00 
  80015e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800165:	00 
  800166:	c7 04 24 19 28 80 00 	movl   $0x802819,(%esp)
  80016d:	e8 9a 17 00 00       	call   80190c <_panic>
}
int
sys_page_insert(envid_t envid, void *va, struct Page *p, int perm)
{
...
int sys_page_waste(struct Page **p, int n)
{
  ...
  80018c:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800195:	b8 11 00 00 00       	mov    $0x11,%eax
...
int sys_page_waste(struct Page **p, int n)
{
  ...
  8001a6:	8b 1c 24             	mov    (%esp),%ebx
  8001a9:	8b 74 24 04          	mov    0x4(%esp),%esi
  8001ad:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8001b1:	89 ec                	mov    %ebp,%esp
  8001b3:	5d                   	pop    %ebp
  8001b4:	c3                   	ret    

008001b5 <sys_receive_packet>:
{
...
int sys_receive_packet(void* buffer)
{
  ...
  8001bb:	89 1c 24             	mov    %ebx,(%esp)
  8001be:	89 74 24 04          	mov    %esi,0x4(%esp)
...
int sys_receive_packet(void* buffer)
{
  ...
  8001db:	8b 1c 24             	mov    (%esp),%ebx
  8001de:	8b 74 24 04          	mov    0x4(%esp),%esi
  8001e2:	8b 7c 24 08          	mov    0x8(%esp),%edi
...
int sys_transmit_packet(void* data, uint32_t len)
{
  ...
  8001ed:	83 ec 38             	sub    $0x38,%esp
  8001f0:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8001f3:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8001f6:	89 7d fc             	mov    %edi,-0x4(%ebp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8001fe:	b8 0f 00 00 00       	mov    $0xf,%eax
  ...
  800211:	7e 28                	jle    80023b <sys_transmit_packet+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800213:	89 44 24 10          	mov    %eax,0x10(%esp)
  800217:	c7 44 24 0c 0f 00 00 	movl   $0xf,0xc(%esp)
  80021e:	00 
  80021f:	c7 44 24 08 fc 27 80 	movl   $0x8027fc,0x8(%esp)
  800226:	00 
  800227:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80022e:	00 
  80022f:	c7 04 24 19 28 80 00 	movl   $0x802819,(%esp)
  800236:	e8 d1 16 00 00       	call   80190c <_panic>
}
...
int sys_transmit_packet(void* data, uint32_t len)
{
  ...
  80023b:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80023e:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800241:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800244:	89 ec                	mov    %ebp,%esp
  800246:	5d                   	pop    %ebp
  800247:	c3                   	ret    

00800248 <sys_time_msec>:
...
sys_time_msec(void)
{
  ...
  800255:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80025e:	b8 0e 00 00 00       	mov    $0xe,%eax
  800263:	89 d1                	mov    %edx,%ecx
  800265:	89 d3                	mov    %edx,%ebx
  800267:	89 d7                	mov    %edx,%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  8002a2:	7e 28                	jle    8002cc <sys_ipc_recv+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002a4:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002a8:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8002af:	00 
  8002b0:	c7 44 24 08 fc 27 80 	movl   $0x8027fc,0x8(%esp)
  8002b7:	00 
  8002b8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8002bf:	00 
  8002c0:	c7 04 24 19 28 80 00 	movl   $0x802819,(%esp)
  8002c7:	e8 40 16 00 00       	call   80190c <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  8002e6:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800302:	8b 1c 24             	mov    (%esp),%ebx
  800305:	8b 74 24 04          	mov    0x4(%esp),%esi
  800309:	8b 7c 24 08          	mov    0x8(%esp),%edi
  80030d:	89 ec                	mov    %ebp,%esp
  80030f:	5d                   	pop    %ebp
  800310:	c3                   	ret    
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800314:	83 ec 38             	sub    $0x38,%esp
  800317:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80031a:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80031d:	89 7d fc             	mov    %edi,-0x4(%ebp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  800320:	bb 00 00 00 00       	mov    $0x0,%ebx
  800325:	b8 0a 00 00 00       	mov    $0xa,%eax
  80032a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  80032d:	8b 55 08             	mov    0x8(%ebp),%edx
  800330:	89 df                	mov    %ebx,%edi
  ...
  800338:	7e 28                	jle    800362 <sys_env_set_pgfault_upcall+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  80033a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80033e:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800345:	00 
  800346:	c7 44 24 08 fc 27 80 	movl   $0x8027fc,0x8(%esp)
  80034d:	00 
  80034e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800355:	00 
  800356:	c7 04 24 19 28 80 00 	movl   $0x802819,(%esp)
  80035d:	e8 aa 15 00 00       	call   80190c <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800362:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800365:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800368:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80036b:	89 ec                	mov    %ebp,%esp
  80036d:	5d                   	pop    %ebp
  80036e:	c3                   	ret    

0080036f <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800372:	83 ec 38             	sub    $0x38,%esp
  800375:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800378:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80037b:	89 7d fc             	mov    %edi,-0x4(%ebp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800383:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  800396:	7e 28                	jle    8003c0 <sys_env_set_trapframe+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800398:	89 44 24 10          	mov    %eax,0x10(%esp)
  80039c:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8003a3:	00 
  8003a4:	c7 44 24 08 fc 27 80 	movl   $0x8027fc,0x8(%esp)
  8003ab:	00 
  8003ac:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8003b3:	00 
  8003b4:	c7 04 24 19 28 80 00 	movl   $0x802819,(%esp)
  8003bb:	e8 4c 15 00 00       	call   80190c <_panic>
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8003c0:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8003c3:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8003c6:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8003c9:	89 ec                	mov    %ebp,%esp
  8003cb:	5d                   	pop    %ebp
  8003cc:	c3                   	ret    

008003cd <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8003e1:	b8 08 00 00 00       	mov    $0x8,%eax
  ...
  8003f4:	7e 28                	jle    80041e <sys_env_set_status+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003f6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003fa:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  800401:	00 
  800402:	c7 44 24 08 fc 27 80 	movl   $0x8027fc,0x8(%esp)
  800409:	00 
  80040a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800411:	00 
  800412:	c7 04 24 19 28 80 00 	movl   $0x802819,(%esp)
  800419:	e8 ee 14 00 00       	call   80190c <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80041e:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800421:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800424:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800427:	89 ec                	mov    %ebp,%esp
  800429:	5d                   	pop    %ebp
  80042a:	c3                   	ret    

0080042b <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80042e:	83 ec 38             	sub    $0x38,%esp
  800431:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800434:	89 75 f8             	mov    %esi,-0x8(%ebp)
  ...
  80043f:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  800452:	7e 28                	jle    80047c <sys_page_unmap+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  800454:	89 44 24 10          	mov    %eax,0x10(%esp)
  800458:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  80045f:	00 
  800460:	c7 44 24 08 fc 27 80 	movl   $0x8027fc,0x8(%esp)
  800467:	00 
  800468:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80046f:	00 
  800470:	c7 04 24 19 28 80 00 	movl   $0x802819,(%esp)
  800477:	e8 90 14 00 00       	call   80190c <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80047c:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80047f:	8b 75 f8             	mov    -0x8(%ebp),%esi
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  80048c:	83 ec 38             	sub    $0x38,%esp
  80048f:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800492:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800495:	89 7d fc             	mov    %edi,-0x4(%ebp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  800498:	b8 05 00 00 00       	mov    $0x5,%eax
  80049d:	8b 75 18             	mov    0x18(%ebp),%esi
  8004a0:	8b 7d 14             	mov    0x14(%ebp),%edi
  8004a3:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  8004b0:	7e 28                	jle    8004da <sys_page_map+0x51>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004b2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004b6:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8004bd:	00 
  8004be:	c7 44 24 08 fc 27 80 	movl   $0x8027fc,0x8(%esp)
  8004c5:	00 
  8004c6:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8004cd:	00 
  8004ce:	c7 04 24 19 28 80 00 	movl   $0x802819,(%esp)
  8004d5:	e8 32 14 00 00       	call   80190c <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8004da:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8004dd:	8b 75 f8             	mov    -0x8(%ebp),%esi
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8004ea:	83 ec 38             	sub    $0x38,%esp
  8004ed:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8004f0:	89 75 f8             	mov    %esi,-0x8(%ebp)
  ...
  80050f:	7e 28                	jle    800539 <sys_page_alloc+0x52>
		panic("syscall %d returned %d (> 0)", num, ret);
  800511:	89 44 24 10          	mov    %eax,0x10(%esp)
  800515:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  80051c:	00 
  80051d:	c7 44 24 08 fc 27 80 	movl   $0x8027fc,0x8(%esp)
  800524:	00 
  800525:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80052c:	00 
  80052d:	c7 04 24 19 28 80 00 	movl   $0x802819,(%esp)
  800534:	e8 d3 13 00 00       	call   80190c <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800539:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80053c:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80053f:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800542:	89 ec                	mov    %ebp,%esp
  800544:	5d                   	pop    %ebp
  800545:	c3                   	ret    
...
sys_yield(void)
{
  ...
  800553:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80055c:	b8 0b 00 00 00       	mov    $0xb,%eax
  800561:	89 d1                	mov    %edx,%ecx
  800563:	89 d3                	mov    %edx,%ebx
  800565:	89 d7                	mov    %edx,%edi
  800567:	89 d6                	mov    %edx,%esi
  800569:	cd 30                	int    $0x30
...
sys_yield(void)
{
  ...
  80056b:	8b 1c 24             	mov    (%esp),%ebx
  80056e:	8b 74 24 04          	mov    0x4(%esp),%esi
  800572:	8b 7c 24 08          	mov    0x8(%esp),%edi
  800576:	89 ec                	mov    %ebp,%esp
  800578:	5d                   	pop    %ebp
  800579:	c3                   	ret    

0080057a <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  800580:	89 1c 24             	mov    %ebx,(%esp)
  800583:	89 74 24 04          	mov    %esi,0x4(%esp)
  800587:	89 7c 24 08          	mov    %edi,0x8(%esp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  800590:	b8 02 00 00 00       	mov    $0x2,%eax
  800595:	89 d1                	mov    %edx,%ecx
  800597:	89 d3                	mov    %edx,%ebx
  800599:	89 d7                	mov    %edx,%edi
  80059b:	89 d6                	mov    %edx,%esi
  80059d:	cd 30                	int    $0x30
...
sys_getenvid(void)
{
  ...
  80059f:	8b 1c 24             	mov    (%esp),%ebx
  8005a2:	8b 74 24 04          	mov    0x4(%esp),%esi
  8005a6:	8b 7c 24 08          	mov    0x8(%esp),%edi
  8005aa:	89 ec                	mov    %ebp,%esp
  8005ac:	5d                   	pop    %ebp
  8005ad:	c3                   	ret    

008005ae <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  8005b1:	83 ec 38             	sub    $0x38,%esp
  8005b4:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8005b7:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8005ba:	89 7d fc             	mov    %edi,-0x4(%ebp)
	// 
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8005d4:	7e 28                	jle    8005fe <sys_env_destroy+0x50>
		panic("syscall %d returned %d (> 0)", num, ret);
  8005d6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8005da:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  8005e1:	00 
  8005e2:	c7 44 24 08 fc 27 80 	movl   $0x8027fc,0x8(%esp)
  8005e9:	00 
  8005ea:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  8005f1:	00 
  8005f2:	c7 04 24 19 28 80 00 	movl   $0x802819,(%esp)
  8005f9:	e8 0e 13 00 00       	call   80190c <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  8005fe:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800601:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800604:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800607:	89 ec                	mov    %ebp,%esp
  800609:	5d                   	pop    %ebp
  80060a:	c3                   	ret    
  80060b:	00 00                	add    %al,(%eax)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	int i;
	for (i = 0; devtab[i]; i++)
  800739:	be a4 28 80 00       	mov    $0x8028a4,%esi
		if (devtab[i]->dev_id == dev_id) {
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80076c:	c7 04 24 28 28 80 00 	movl   $0x802828,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800851:	c7 04 24 48 28 80 00 	movl   $0x802848,(%esp)
  ...
  8008b1:	e8 6b fe ff ff       	call   800721 <dev_lookup>
{
  ...
  8008d3:	c7 04 24 69 28 80 00 	movl   $0x802869,(%esp)
  ...
  80093a:	e8 e2 fd ff ff       	call   800721 <dev_lookup>
{
  ...
  800961:	c7 04 24 86 28 80 00 	movl   $0x802886,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  800a60:	e8 c6 f9 ff ff       	call   80042b <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  800bae:	e8 d6 f8 ff ff       	call   800489 <sys_page_map>
  ...
  800be9:	e8 9b f8 ff ff       	call   800489 <sys_page_map>
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ea6:	c7 44 24 04 b8 28 80 	movl   $0x8028b8,0x4(%esp)
  800ead:	00 
...
alloc_sockfd(int sockid)
{
  ...
  800f5f:	e8 83 f5 ff ff       	call   8004e7 <sys_page_alloc>
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  8011c8:	c7 44 24 0c c4 28 80 	movl   $0x8028c4,0xc(%esp)
  8011cf:	00 
  8011d0:	c7 44 24 08 d0 28 80 	movl   $0x8028d0,0x8(%esp)
  8011d7:	00 
  8011d8:	c7 44 24 04 66 00 00 	movl   $0x66,0x4(%esp)
  8011df:	00 
  8011e0:	c7 04 24 e5 28 80 00 	movl   $0x8028e5,(%esp)
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  80125d:	c7 44 24 0c f1 28 80 	movl   $0x8028f1,0xc(%esp)
  801264:	00 
  801265:	c7 44 24 08 d0 28 80 	movl   $0x8028d0,0x8(%esp)
  80126c:	00 
  80126d:	c7 44 24 04 5b 00 00 	movl   $0x5b,0x4(%esp)
  801274:	00 
  801275:	c7 04 24 e5 28 80 00 	movl   $0x8028e5,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80139c:	c7 44 24 04 06 29 80 	movl   $0x802906,0x4(%esp)
  8013a3:	00 
...
devpipe_close(struct Fd *fd)
{
  ...
  8013ef:	e8 37 f0 ff ff       	call   80042b <sys_page_unmap>
  ...
  801407:	e8 1f f0 ff ff       	call   80042b <sys_page_unmap>
}
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  80146e:	c7 04 24 0d 29 80 00 	movl   $0x80290d,(%esp)
...
devpipe_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8014b8:	e8 89 f0 ff ff       	call   800546 <sys_yield>
		cprintf("[%08x] devpipe_write %08x %d rpos %d wpos %d\n",
			env->env_id, vpt[VPN(p)], n, p->p_rpos, p->p_wpos);
...
devpipe_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  80154e:	eb 49                	jmp    801599 <devpipe_read+0x8b>
			...
			sys_yield();
  801550:	e8 f1 ef ff ff       	call   800546 <sys_yield>
		cprintf("[%08x] devpipe_read %08x %d rpos %d wpos %d\n",
			env->env_id, vpt[VPN(p)], n, p->p_rpos, p->p_wpos);
...
pipe(int pfd[2])
{
  ...
  801616:	e8 cc ee ff ff       	call   8004e7 <sys_page_alloc>
  ...
  801650:	e8 92 ee ff ff       	call   8004e7 <sys_page_alloc>
  ...
  80167f:	e8 63 ee ff ff       	call   8004e7 <sys_page_alloc>
  ...
  8016b8:	e8 cc ed ff ff       	call   800489 <sys_page_map>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801770:	c7 44 24 04 25 29 80 	movl   $0x802925,0x4(%esp)
  801777:	00 
...
devcons_write(struct Fd *fd, const void *vbuf, size_t n)
{
  ...
  8017d7:	e8 10 e9 ff ff       	call   8000ec <sys_cputs>
	int tot, m;
	char buf[128];
...
cputchar(int ch)
{
  ...
  80180c:	e8 db e8 ff ff       	call   8000ec <sys_cputs>
}
  801811:	c9                   	leave  
  801812:	c3                   	ret    
...
devcons_read(struct Fd *fd, void *vbuf, size_t n)
{
  ...
  80181f:	eb 28                	jmp    801849 <devcons_read+0x36>
	...
	while ((c = sys_cgetc()) == 0)
		sys_yield();
  801821:	e8 20 ed ff ff       	call   800546 <sys_yield>
	int c;
  ...
  801828:	e8 8b e8 ff ff       	call   8000b8 <sys_cgetc>
...
opencons(void)
{
  ...
  80187b:	e8 67 ec ff ff       	call   8004e7 <sys_page_alloc>
...
_panic(const char *file, int line, const char *fmt,...)
  ...
  801923:	c7 04 24 31 29 80 00 	movl   $0x802931,(%esp)
  ...
  801946:	c7 04 24 36 29 80 00 	movl   $0x802936,(%esp)
  ...
  80195c:	e8 0f 00 00 00       	call   801970 <vcprintf>
	cprintf("\n");
  801961:	c7 04 24 1e 29 80 00 	movl   $0x80291e,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8019c4:	e8 23 e7 ff ff       	call   8000ec <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  801a18:	e8 cf e6 ff ff       	call   8000ec <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801b11:	0f be 80 52 29 80 00 	movsbl 0x802952(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801ccf:	c7 44 24 08 63 29 80 	movl   $0x802963,0x8(%esp)
  801cd6:	00 
  ...
  801cef:	c7 44 24 08 e2 28 80 	movl   $0x8028e2,0x8(%esp)
  801cf6:	00 
  ...
  801d2b:	c7 45 e0 6c 29 80 00 	movl   $0x80296c,-0x20(%ebp)
				p = "(null)";
			if (width > 0 && padc != '-')
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  802489:	e8 7e f4 ff ff       	call   80190c <_panic>
		sys_yield();
  80248e:	e8 b3 e0 ff ff       	call   800546 <sys_yield>
{
	// LAB 4: Your code here.
	int r;
	if (pg == NULL)
  ...
  8024a5:	e8 2f de ff ff       	call   8002d9 <sys_ipc_try_send>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8024d3:	e8 a4 dd ff ff       	call   80027c <sys_ipc_recv>
