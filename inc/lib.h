...
int 	sys_transmit_packet(void*, uint32_t);
int 	sys_receive_packet(void*);
int	sys_page_waste(struct Page **, int);
int	sys_page_insert(envid_t env, void *, struct Page*,int);
